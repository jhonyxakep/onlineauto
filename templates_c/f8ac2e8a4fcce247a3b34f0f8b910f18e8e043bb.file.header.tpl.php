<?php /* Smarty version Smarty-3.1.13, created on 2015-06-09 15:16:59
         compiled from "Z:\home\onlineauto.su\www\templates\header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:153815577036b851324-32802012%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f8ac2e8a4fcce247a3b34f0f8b910f18e8e043bb' => 
    array (
      0 => 'Z:\\home\\onlineauto.su\\www\\templates\\header.tpl',
      1 => 1433844756,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '153815577036b851324-32802012',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_5577036b85cfc8_58101937',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5577036b85cfc8_58101937')) {function content_5577036b85cfc8_58101937($_smarty_tpl) {?><header>
	<div class="row">
		<div class="col-xs-10 big-col">
			...
			<nav>
				<ul><li class="gradient"><a href="javascript:;" class="with_arrow"><div class="icon"></div>О нас<div class="arrow"></div></a><ul><li><a href="#">О компании</a></li><li><a href="#">Контакты</a></li><li><a href="#">Гарантии</a></li><li><a href="#">Новости</a></li><li><a href="#">Видеотрансляция офиса</a></li></ul></li><li class="gradient"><a href="javascript:;" class="with_arrow"><div class="icon"></div>Услуги<div class="arrow"></div></a><ul><li><a href="#">Автомобили из Японии</a></li><li><a href="#">Автомобили из Америки</a></li><li><a href="#">Осмотр и проверка Б/У авто</a></li><li><a href="#">Конструкторы и распилы из Японии</a></li><li><a href="#">Дополнительные услуги</a></li></ul></li><li class="gradient"><a href="javascript:;" class="with_arrow"><div class="icon"></div>Сервисы<div class="arrow"></div></a><ul><li><a href="#">Автокалькулятор (Япония)</a></li><li><a href="#">Автокалькулятор (США)</a></li><li><a href="#">Калькулятор распилов и конструкторов</a></li><li><a href="#">Определение даты выпуска (Япония)</a></li><li><a href="#">Каталог автомобилей</a></li><li><a href="#">Аукционная статистика</a></li></ul></li><li class="gradient"><a href="#"><div class="icon"></div>Помощь</a></li></ul>
			</nav>
		</div>
		...
		<div class="col-xs-10 big-col">
			<div class="banner">
				...
				<div class="bottom_menu">
					<ul><li><a href="#" class="active">15 Лет на рынке</a></li><li><a href="#">Официальная Российская компания</a></li><li><a href="#">Любые удобные виды оплаты</a></li><li><a href="#">Тысячи выполненных заказов</a></li><li><a href="#">Гарантии</a></li></ul>
				</div>
			</div>
		</div>
		<div class="col-xs-2 small-col">
			<a href="#registration_popup" id="reg_button" class="reg gray_with_icon"><div class="icon_block"></div><div class="button_gray">Регистрация</div></a>
			<a href="#" class="cabinet gray_with_icon"><div class="icon_block"></div><div class="button_gray">Личный кабинет</div></a>
			<ul class="social"><li class="mail"><a href="#"></a></li><li class="vk"><a href="#"></a></li><li class="fb"><a href="#"></a></li><li class="ok"><a href="#"></a></li></ul>
		</div>
	</div>
